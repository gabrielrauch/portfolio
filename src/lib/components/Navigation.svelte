<script lang="ts">
	...
	function openResume() {
		window.open('https://example.com/resume.pdf');
	}
...
<nav class="glass sticky top-0 z-10 w-full border-b border-gray-200 dark:border-gray-700">
	<div class="container flex h-14 items-center justify-between">
		...
		<div class="hidden space-x-6 text-sm md:flex">
			...
			<span class="text-muted-foreground cursor-not-allowed opacity-50" title="Coming Soon">
				~/blog
			</span>
		</div>
